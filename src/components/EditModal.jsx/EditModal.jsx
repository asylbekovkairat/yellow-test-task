...
export default function EditModal({ setActiveEdit, editSubmit, 
  setDate, setTime, setDistance, 
  distance, time, date, activeEdit,}) {

  return (
    <div className={`editModal_wrapper ${activeEdit ? "active" : ""}`}>
      <form onSubmit={editSubmit} className="editModal_window">
        <div className="cancelBtn">
          <img onClick={() => setActiveEdit(false)} src="./images/cancel.svg" alt="cancel"/>
        </div>
        <label>
          <div>Distance</div>
